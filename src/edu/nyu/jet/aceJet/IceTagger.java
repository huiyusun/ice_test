...
public class IceTagger {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length != 3) {
			System.err.println(IceTagger.class.getName() + " propsFile txtFileList outputFileList");
			System.exit(-1);
		}
		...
		loadModel(JetTest.getConfig("Jet.dataPath") + File.separator + JetTest.getConfig("Ace.RelationModel.fileName"),
				"null");
		if (searchMode) {
			...
			pathRelationExtractor.updateWeights(0.8, 0.3, 1.2);
