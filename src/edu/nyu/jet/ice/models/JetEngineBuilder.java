...
/**
 * writes files to be read by Jet containing information on entity sets and relations.
 */
...
public class JetEngineBuilder {
	...
	/**
	 * writes auxEDTtypeFile containing common nouns in new entity types.
	 */
	...
	/**
	 * writes onoma (name dictionary) containing names in new entity types.
	 */
	...
	public static void buildRelationPatternFileFromNames(Writer w, Writer negw, List<String> relationNames)
			throws IOException {
