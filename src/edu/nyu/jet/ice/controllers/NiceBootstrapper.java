...
public class NiceBootstrapper {
    ...
    public static NiceBootstrapper instance;
    ...
    public static void main(String[] args) {
        ...
        if (!Ice.corpora.isEmpty()) {
            if (Ice.iceProperties.getProperty("Ice.Control.SelectedCorpus") != null) {
                Ice.selectCorpus(Ice.iceProperties.getProperty("Ice.Control.SelectedCorpus"));
                System.err.println("Selected based on properties file: " +
                        Ice.iceProperties.getProperty("Ice.Control.SelectedCorpus"));
            }
            else {
                Ice.selectCorpus(Ice.corpora.firstKey());
            }
        }
        ActiveLearner.pathMatcher = new PathMatcher();
...
//                swingEntitySetPanel, swingRelationsPanel);
        assembleTabs(contentPane,  swingPathsPanel, swingRelationsPanel);
