...
/**
 * When the 'expand' button om the relation frame is pushed, the SwingRelationPanel creates a RelationBuilderThread to
 * perform the computations required to generate a list of candidate relation patterns (which are then reviewed by the
 * user).
 *
...
public class RelationBuilderThread extends Thread {
	...
	public RelationBuilderThread(String seed, String relationInstanceFileName, String pathListFileName,
			RelationBuilder builder, ActiveLearner bootstrap, RelationBuilderFrame frame,
			SwingRelationsPanel swingRelationsPanel) {
		args = new String[3];
		args[0] = seed;
